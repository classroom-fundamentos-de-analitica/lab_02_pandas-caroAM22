...
def pregunta_11():
    ...
    39   39    a,d,f
    """
    tbl1_sorted = tbl1.sort_values(by="_c4")
    return tbl1_sorted.groupby("_c0")["_c4"].apply(lambda x: ",".join(x)).reset_index()
...
def pregunta_12():
    ...
    return (
        tbl2_sorted.assign(
            _c5=tbl2[["_c5a", "_c5b"]].apply(lambda x: f"{x[0]}:{x[1]}", axis=1)
        )
        .groupby("_c0")["_c5"]
